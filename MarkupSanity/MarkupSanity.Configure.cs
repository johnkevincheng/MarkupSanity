...
namespace RockFluid
{
    public static partial class MarkupSanity
    {
        ...
        public partial class SanitizeConfigurations
        {
            ...
            /// </summary>
            public List<String> CustomScriptableAttributes { get; set; }
            ...
            /// </summary>
            public List<String> CustomScriptableAttributeSignatures { get; set; }
            ...
            /// </remarks>
            public List<String> CustomBlacklistedTags { get; set; }
            ...
            /// </remarks>
            public List<String> SupplementalTags { get; set; }
            ...
            /// Add values here if the defaults are acceptable, but would like to add more to it.
            /// </remarks>
            public List<String> SupplementalAttributes { get; set; }
            ...
            /// Add values here if the defaults are acceptable, but would like to add more to it.
            /// </remarks>
            public List<String> SupplementalScriptableAttributes { get; set; }
